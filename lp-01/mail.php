...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:1.5rem 0;font-size:1.4rem;color:#FF8A27;text-decoration:none" href="index.html" target="_blank">- re Plus Design -</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
